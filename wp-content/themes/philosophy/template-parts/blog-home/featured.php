...
while($philosophy_fp->have_posts()){
   ...
   $post_data[] = array(
      ...
      "date"=>get_the_date(),
      "avatar_url"=>get_author_posts_url(get_the_author_meta("ID")),
      "cat"=>$category->name,
               ...
               <div class="entry" style="background-image:url('<?php echo esc_url( $post_data[0]["thumbnail"]);?>');">
                     ...
                     <div class="entry__content">
                        ...
                        <div class="entry__info">
                           <a href="<?php echo esc_url($post_data[0]['avatar_url']) ?>" class="entry__profile-pic">
                                 <img class="avatar" src="<?php echo esc_url($post_data[0]["avatar"]);?>" alt="<?php echo esc_url($post_data[0]["avatar"]);?>">
                           </a>

                           <ul class="entry__meta">
                                 <li><a href="<?php echo esc_url($post_data[0]['avatar_url']) ?>"><?php echo esc_html($post_data[0]["author"]);?></a></li>
               ...
               ?>
                <div class="entry" style="background-image:url('<?php echo esc_url( $post_data[$i]["thumbnail"]);?>');">
                     ...
                     <div class="entry__content">
                        ...
                        <div class="entry__info">
                           <a href="<?php echo esc_url($post_data[$i]['avatar_url']) ?>" class="entry__profile-pic">
                                 <img class="avatar" src="<?php echo esc_url($post_data[$i]["avatar"]);?>" alt="<?php echo esc_url($post_data[$i]["avatar"]);?>">
                           </a>

                           <ul class="entry__meta">
                                 <li><a href="<?php echo esc_url($post_data[$i]['avatar_url']) ?>"><?php echo esc_html($post_data[$i]["author"]);?></a></li>

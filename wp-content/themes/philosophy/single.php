                ...
                <div class="s-content__author">
                    ...
                    <div class="s-content__author-about">
                        ...
                        <ul class="s-content__author-social">
                           ...
                           $philosophy_author_googleplus = get_field("googleplus","user_".get_the_author_meta("ID"));
                           ?>
                           ...
                           <?php endif;?>
                           <?php if($philosophy_author_googleplus):?>
                              <li><a href="<?php echo esc_url($philosophy_author_googleplus); ?>">GooglePlus</a></li>
                           <?php endif;?>
                        </ul>
                    </div>
                </div>
                ...
                <div class="s-content__pagenav">
                    <div class="s-content__nav">
                       ...
                       ?>
                        ...
                        <?php endif;?>
                       <?php 
                       $philosophy_prev_next = get_next_post();
                       if($philosophy_prev_next):
                       ?>
                        <div class="s-content__next">
                            <a href="<?php echo esc_url(get_the_permalink($philosophy_prev_next)); ?>" rel="next">
                                <span><?php _e("Next Post","philosophy");?></span>
                                <?php echo esc_html( get_the_title($philosophy_prev_next));?> 
                            </a>
                        </div>
                        <?php endif;?>
                    </div>

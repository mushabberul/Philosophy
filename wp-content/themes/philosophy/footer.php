...
<div class="row top">
    ...
    <div class="col-eight md-six tab-full popular">
        ...
        <div class="block-1-2 block-m-full popular__posts">
            <?php 
            $philosophy_popular_post = new WP_Query(
                array(
                    "posts_per_page"=>6,
            ...
            <article class="col-block popular__post">
                ...
                <section class="popular__meta">
                    ...
                    <span class="popular__date"><span>on</span> <time datetime="2017-12-19"><?php echo esc_html(get_the_date());?></time></span>
                </section>
            </article>
    ...
    <div class="col-four md-six tab-full about">
        <?php 
        if(is_active_sidebar("befor-footer-section")){
            dynamic_sidebar("befor-footer-section");
        }
        ?>
